...
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221012121216.png)
...
直观解释：
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221014225958.png)
...
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221018125347.png)
...
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221017225107.png)
...
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221017233927.png)
...
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221020102411.png)
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221020102417.png)
...
引用一下LDA数学八卦的图：
![](https://cdn.jsdelivr.net/gh/vllbc/img4blog//image/Pasted%20image%2020221019104516.png)
...
输出: 文本的话题序列 $\mathrm{z}=\{\mathbf{z}_1, \cdots, \mathbf{z}_m, \cdots, \mathbf{z}_M\}, \mathbf{z}_m=\left(z_{m 1}, \cdots, z_{m n}, \cdots, z_{m_{N_m}}\right)$ 的后验概率分布 $p(\mathbf{z} \mid \mathbf{w}, \alpha, \beta)$ 的样本计数, 模型的参数 $\varphi$ 和 $\theta$ 的估计值;
